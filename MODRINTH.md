...
- Configurable rarity filters:
  ...
  - Ultra Beast
  - perfect IVs
  - high IVs, default threshold 90%
- Configurable rare-spawn range:
  - block radius
  - chunk radius
  - whole dimension
- Optional spawn details:
  - clickable coordinates
  - biome
  - level
  - IV total
- English and French localization.
- Mod Menu support through Cloth Config.
...
- Alerts are sent through chat only.
